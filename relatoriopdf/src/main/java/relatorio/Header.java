...
public class Header extends PdfPageEventHelper {
	...
	public void first_header(PdfWriter writer,Document document,String nome_escola,int inep, int ano, int turma,String grau,String PICT) throws MalformedURLException, IOException, DocumentException {
	    ...
	    Phrase header3		= new Phrase("SECRETARIA MUNICIPAL DE EDUCAÇÃO", headerfont);
