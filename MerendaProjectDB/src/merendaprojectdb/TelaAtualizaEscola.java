 ...
 * @author gdsm
 */
public class TelaAtualizaEscola extends javax.swing.JFrame {
     ...
     */
    public TelaAtualizaEscola(String nome, String e) {
        initComponents();
        usuario=nome;
        nomeEscola=e;
        
        escola = BdManager.findEscola(nomeEscola);
        
        campoEstado.setSelectedItem(escola.getEstado());
        campoPrefeitura.setText(escola.getPrefeitura());
        campoDistrito.setText(escola.getDistrito());
        campoSec.setText(escola.getSecretaria());
        campoSubSec.setText(escola.getSubsecretaria());
        campoDept.setText(escola.getDepartamento());
        //campoINEP.setText(String.valueOf(escola.getINEP()));
        campoDiretoria.setText(escola.getDiretoria());
        campoUnidade.setText(escola.getUnidade());
        campoDDD.setText(escola.getTelefone().substring(0,2));
        campoTel.setText(escola.getTelefone().substring(2));
    }
    ...
    private void atualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_atualizarActionPerformed
        ...
        {
            String inep = Integer.toString(escola.getINEP());
            
            if(!BdManager.verificaEscola(inep))
            {
                JOptionPane.showMessageDialog(null,"Esta escola não existe no banco");
            }
            else
            {
                ...
                Escola escolaAtual = new Escola(""+estado,pref, dist, sec, subsec, dept, escola.getINEP(), diretoria, unidade, telefone);
                BdManager.alterarEscola(escolaAtual, escolaAtual.getINEP());
