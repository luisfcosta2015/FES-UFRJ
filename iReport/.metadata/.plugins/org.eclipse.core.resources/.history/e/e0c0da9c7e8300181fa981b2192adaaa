...
import br.com.fes.relatorios.factory.ConexaoBanco;

public class DadosDAO {
	
	ConexaoBanco con = new ConexaoBanco();
	
	public ResultSet consultar(Dados dados) throws SQLException, Exception{
		...
		if(!(dados.getMatrícula().toString().isEmpty()) || !(dados.getNome().isEmpty()) || !(dados.getIdade().isEmpty()) || !(dados.getDataNascimento().toString().isEmpty()) || !(dados.getEscola().isEmpty()) || !(dados.getSerie().isEmpty())){
			...
			return con.select(query.toString());
		}
		...
		if((!(dados.getMatrícula().toString().isEmpty()) || !(dados.getNome().isEmpty()) || !(dados.getIdade().isEmpty())) && !(dados.getDataNascimento() == null)){
