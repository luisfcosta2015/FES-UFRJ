...
public class Conexao {
    ...
    */
    ...
    public boolean cadastra_pessoa(int id_funcao, String nome, String cpf, String matricula, String usuario, String senha){
        
        // criptografa a senha pra gravar no BD
        senha = Auxiliar.criptografar(senha);
        
        String query = "INSERT INTO pessoa (id_funcao, nome, cpf, matricula, usuario, senha) VALUES";
        query += "("+ id_funcao +", " + "\'" + nome + "\',\'" + cpf + "\',\'" + matricula;
        query += "\',\'" + usuario + "\',\'" + senha +"\')" ;
        
        return query_update(query);
    }
    
    public boolean cadastra_instituicao(String nome, String endereco, String INEP, String qtdAlunos, String telefone, int diretor, int tipo){
        
        String query;
        if (diretor == -1){
            query = "INSERT INTO instituicao (nome, endereco, inep, qtd_alunos, telefone, id_tipo) VALUES";
            query += "(\'" + nome +"\', " + "\'" + endereco + "\',\'" + INEP + "\'," + qtdAlunos;
            query += ",\'" + telefone +"\', " + tipo + ")" ;
        } else {
            query = "INSERT INTO instituicao (nome, endereco, inep, qtd_alunos, telefone, id_diretor, id_tipo) VALUES";
            query += "(\'" + nome +"\', " + "\'" + endereco + "\',\'" + INEP + "\'," + qtdAlunos;
            query += ",\'" + telefone +"\', " + diretor + ", " + tipo + ")" ;
        }
        
        return query_update(query);
    }
    
    public boolean cadastra_alimento(String nome, String fornecedor, String marca, boolean perecivel, String medida, int qtd_atende){
        
        String query = "INSERT INTO alimento (nome,fornecedor, marca, perecivel, medida ,qtd_atende) VALUES";
        query += "(\'"+ nome +"\', \'" +fornecedor + "\',\'" + marca + "\'" ;
        query += ", "+ perecivel +", " + "\'" + medida + "\'," + qtd_atende + ")" ;
    ...
    public List<Map<String, Object>> pessoaPorId(int id){
    ...
    public List<Map<String, Object>> funcaoPorId(int id){
    ...
    public List<Map<String, Object>> pessoaPorNome(String nome){
